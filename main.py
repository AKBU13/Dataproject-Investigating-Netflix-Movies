...
# Iterate over the labels and rows of the DataFrame and check if the duration is less than 99, if it is, add 1 to the counter, if it isn't, the counter should remain the same
